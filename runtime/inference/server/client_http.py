...
def register_client_contract_routes(
    ...
    *,
    ...
    """Register bootstrap and native-audio discovery routes.

    Providers can later be replaced with a real native audio service without
    changing the Expo API contract.
    """
